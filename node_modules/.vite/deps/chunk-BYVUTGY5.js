        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 2:
              ...
              if (!(this.config.cache.claimsBasedCachingEnabled && request.claims && !StringUtils.isEmptyObj(request.claims))) return [3, 4];
              _a = validatedRequest;
    ...
    NativeInteractionClient2.prototype.generatePopAccessToken = function(response, request) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            case 0:
              if (!(request.tokenType === AuthenticationScheme.POP)) return [3, 2];
              if (response.shr) {
        ...
        return __generator(this, function(_a) {
          switch (_a.label) {
            ...
            case 2:
              ...
              if (!(request.authenticationScheme === AuthenticationScheme.POP)) return [3, 4];
              shrParameters = {
                resourceRequestUri: request.resourceRequestUri,
                resourceRequestMethod: request.resourceRequestMethod,
                shrClaims: request.shrClaims,
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              ...
              if (!allowNativeBroker) return [3, 4];
              _b.label = 1;
            case 1:
              _b.trys.push([1, 3, , 4]);
              _a = this;
            ...
            case 3:
              ...
              return [3, 4];
            case 4:
              if (!!this.config.cache.claimsBasedCachingEnabled) return [3, 6];
...
@azure/msal-browser/dist/index.js:
  (*! @azure/msal-browser v2.39.0 2024-06-06 *)
*/
//# sourceMappingURL=chunk-BYVUTGY5.js.map
